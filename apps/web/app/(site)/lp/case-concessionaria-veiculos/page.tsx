...
// Transcrita do site original (lp/case-concessionaria-veiculos.html) por scripts/transcribe-site.py.
// Conteudo e marcacao sao os do original; o que mudou foi apenas a stack em volta.
export const metadata:Metadata={title:"Como uma concessionaria pode acelerar test drives e recuperar negociacoes com IA. | FAT Tech",description:"Case automotivo. Este case demonstra uma opera\u00e7\u00e3o automotiva em que a velocidade de resposta, o filtro do interesse e o follow-up fizeram o estoque girar melh",alternates:{canonical:"https://fattech.com.br/lp/case-concessionaria-veiculos"},robots:{index:true,follow:true},twitter:{card:"summary_large_image",title:"Como uma concessionaria pode acelerar test drives e recuperar negociacoes com IA. | FAT Tech",description:"Case automotivo. Este case demonstra uma opera\u00e7\u00e3o automotiva em que a velocidade de resposta, o filtro do interesse e o follow-up fizeram o estoque girar melh",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"]},openGraph:{title:"Como uma concessionaria pode acelerar test drives e recuperar negociacoes com IA. | FAT Tech",description:"Case automotivo. Este case demonstra uma opera\u00e7\u00e3o automotiva em que a velocidade de resposta, o filtro do interesse e o follow-up fizeram o estoque girar melh",type:"website",locale:"pt_BR",siteName:"FAT Tech",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"],url:"https://fattech.com.br/lp/case-concessionaria-veiculos"}};
...
<div className="lp-nav-inner"><a className="lp-brand" href="/" aria-label="Voltar para a home da FAT Tech"><img src="/dist/Logo_FATTech_Nova-B-ZGug9A.png" alt="Logo FAT Tech - Case automotivo" style={{width:"52px",height:"52px",objectFit:"contain",filter:"drop-shadow(0 0 18px rgba(0,240,255,.18))"}} />
<div>
<div className="lp-brand-mark">FAT Tech</div>
<div className="lp-brand-meta">Case automotivo</div></div></a>
<nav className="lp-nav-links" aria-label="Atalhos da landing page"><a href="/">Site Principal</a><a href="/crm.html">CRM IA</a><a href="#preco">Investimento</a><a href="https://wa.me/5535998491017?text=Vi+o+case+da+concessionaria+e+quero+implantar+essa+estrutura+de+atendimento%2C+test+drive+e+follow-up+com+IA." target="_blank" rel="noopener noreferrer">WhatsApp</a></nav></div></header>
<main>
...
<h1>Como uma concessionaria pode acelerar test drives e recuperar negociacoes com IA.</h1>
<p className="lp-lead">Este case demonstra uma operação automotiva em que a velocidade de resposta, o filtro do interesse e o follow-up fizeram o estoque girar melhor.</p>
<div className="lp-hero-actions"><a className="lp-btn" href="https://wa.me/5535998491017?text=Vi+o+case+da+concessionaria+e+quero+implantar+essa+estrutura+de+atendimento%2C+test+drive+e+follow-up+com+IA." target="_blank" rel="noopener noreferrer">Quero esse modelo na minha concessionaria</a><a className="lp-btn-secondary" href="#solucao">Ver a estrutura</a></div>
...
<h2 className="lp-section-title">O gargalo não era oferta. Era processo comercial.</h2>
...
<p className="lp-section-sub">Quando a operação responde melhor e acompanha mais, a taxa de aproveitamento sobe.</p></div>
...
<h3>S.Y.N.A.P.S.E. para Case automotivo</h3>
...
<div className="lp-hero-actions" style={{marginTop:"24px"}}><a className="lp-btn" href="https://wa.me/5535998491017?text=Vi+o+case+da+concessionaria+e+quero+implantar+essa+estrutura+de+atendimento%2C+test+drive+e+follow-up+com+IA." target="_blank" rel="noopener noreferrer">Quero esse modelo na minha concessionaria</a></div></article></div></section>
