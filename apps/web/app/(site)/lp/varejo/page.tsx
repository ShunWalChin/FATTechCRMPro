...
// Transcrita do site original (lp/varejo.html) por scripts/transcribe-site.py.
// Conteudo e marcacao sao os do original; o que mudou foi apenas a stack em volta.
export const metadata:Metadata={title:"Sua loja vendendo mais com IA para recuperar carrinho, reativar clientes e responder com velocidade. | FAT Tech",description:"Varejo com IA. A FAT Tech implanta uma maquina comercial para varejo e e-commerce que usa WhatsApp Oficial, CRM e IA para recuperar oportunidade perdida.",alternates:{canonical:"https://fattech.com.br/lp/varejo"},robots:{index:true,follow:true},twitter:{card:"summary_large_image",title:"Sua loja vendendo mais com IA para recuperar carrinho, reativar clientes e responder com velocidade. | FAT Tech",description:"Varejo com IA. A FAT Tech implanta uma maquina comercial para varejo e e-commerce que usa WhatsApp Oficial, CRM e IA para recuperar oportunidade perdida.",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"]},openGraph:{title:"Sua loja vendendo mais com IA para recuperar carrinho, reativar clientes e responder com velocidade. | FAT Tech",description:"Varejo com IA. A FAT Tech implanta uma maquina comercial para varejo e e-commerce que usa WhatsApp Oficial, CRM e IA para recuperar oportunidade perdida.",type:"website",locale:"pt_BR",siteName:"FAT Tech",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"],url:"https://fattech.com.br/lp/varejo"}};
...
<div className="lp-nav-inner"><a className="lp-brand" href="/" aria-label="Voltar para a home da FAT Tech"><img src="/dist/Logo_FATTech_Nova-B-ZGug9A.png" alt="Logo FAT Tech - Varejo com IA" style={{width:"52px",height:"52px",objectFit:"contain",filter:"drop-shadow(0 0 18px rgba(0,240,255,.18))"}} />
<div>
<div className="lp-brand-mark">FAT Tech</div>
<div className="lp-brand-meta">Varejo com IA</div></div></a>
<nav className="lp-nav-links" aria-label="Atalhos da landing page"><a href="/">Site Principal</a><a href="/crm.html">CRM IA</a><a href="#preco">Investimento</a><a href="https://wa.me/5535998491017?text=Tenho+uma+loja+e+quero+usar+IA+para+recuperar+carrinho%2C+reativar+clientes+e+vender+mais+no+WhatsApp." target="_blank" rel="noopener noreferrer">WhatsApp</a></nav></div></header>
<main>
...
<h1>Sua loja vendendo mais com IA para recuperar carrinho, reativar clientes e responder com velocidade.</h1>
<p className="lp-lead">A FAT Tech implanta uma maquina comercial para varejo e e-commerce que usa WhatsApp Oficial, CRM e IA para recuperar oportunidade perdida.</p>
<div className="lp-hero-actions"><a className="lp-btn" href="https://wa.me/5535998491017?text=Tenho+uma+loja+e+quero+usar+IA+para+recuperar+carrinho%2C+reativar+clientes+e+vender+mais+no+WhatsApp." target="_blank" rel="noopener noreferrer">Quero aplicar na minha loja</a><a className="lp-btn-secondary" href="#solucao">Ver a estrutura</a></div>
<div className="showcase-radar">
<article className="showcase-signal lp-reveal"><strong>+22%</strong><span>vendas</span>
<p>Sem uma esteira clara, a equipe responde de forma desigual e perde contexto.</p></article>
<article className="showcase-signal lp-reveal"><strong>-12%</strong><span>custo por cliente</span>
<p>Contatos bons e frios se misturam, drenando tempo e energia comercial.</p></article>
<article className="showcase-signal lp-reveal"><strong>14%</strong><span>carrinho recuperado</span>
...
<h2 className="lp-section-title">O varejo deixa dinheiro na mesa todos os dias.</h2>
...
<p className="lp-section-sub">Quando relacionamento e processo entram, o CAC pesa menos.</p></div>
...
<h3>S.Y.N.A.P.S.E. para Varejo com IA</h3>
...
<div className="lp-hero-actions" style={{marginTop:"24px"}}><a className="lp-btn" href="https://wa.me/5535998491017?text=Tenho+uma+loja+e+quero+usar+IA+para+recuperar+carrinho%2C+reativar+clientes+e+vender+mais+no+WhatsApp." target="_blank" rel="noopener noreferrer">Quero aplicar na minha loja</a></div></article></div></section>
