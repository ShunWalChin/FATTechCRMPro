...
// Transcrita do site original (lp/case-clinica-odontologica.html) por scripts/transcribe-site.py.
// Conteudo e marcacao sao os do original; o que mudou foi apenas a stack em volta.
export const metadata:Metadata={title:"Como uma cl\u00ednica odontol\u00f3gica pode reduzir faltas e preencher agenda com IA. | FAT Tech",description:"Case de sa\u00fade. Aqui mostramos a l\u00f3gica por tras de um case de sa\u00fade em que agenda, confirma\u00e7\u00e3o e reativa\u00e7\u00e3o passaram a operar com muito mais previsibilidade.",alternates:{canonical:"https://fattech.com.br/lp/case-clinica-odontologica"},robots:{index:true,follow:true},twitter:{card:"summary_large_image",title:"Como uma cl\u00ednica odontol\u00f3gica pode reduzir faltas e preencher agenda com IA. | FAT Tech",description:"Case de sa\u00fade. Aqui mostramos a l\u00f3gica por tras de um case de sa\u00fade em que agenda, confirma\u00e7\u00e3o e reativa\u00e7\u00e3o passaram a operar com muito mais previsibilidade.",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"]},openGraph:{title:"Como uma cl\u00ednica odontol\u00f3gica pode reduzir faltas e preencher agenda com IA. | FAT Tech",description:"Case de sa\u00fade. Aqui mostramos a l\u00f3gica por tras de um case de sa\u00fade em que agenda, confirma\u00e7\u00e3o e reativa\u00e7\u00e3o passaram a operar com muito mais previsibilidade.",type:"website",locale:"pt_BR",siteName:"FAT Tech",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"],url:"https://fattech.com.br/lp/case-clinica-odontologica"}};
...
<div className="lp-nav-inner"><a className="lp-brand" href="/" aria-label="Voltar para a home da FAT Tech"><img src="/dist/Logo_FATTech_Nova-B-ZGug9A.png" alt="Logo FAT Tech - Case de sa\u00fade" style={{width:"52px",height:"52px",objectFit:"contain",filter:"drop-shadow(0 0 18px rgba(0,240,255,.18))"}} />
<div>
<div className="lp-brand-mark">FAT Tech</div>
<div className="lp-brand-meta">Case de saúde</div></div></a>
<nav className="lp-nav-links" aria-label="Atalhos da landing page"><a href="/">Site Principal</a><a href="/crm.html">CRM IA</a><a href="#preco">Investimento</a><a href="https://wa.me/5535998491017?text=Vi+o+case+da+cl%C3%ADnica+odontol%C3%B3gica+e+quero+montar+essa+estrutura+de+agenda+e+reativa%C3%A7%C3%A3o+na+minha+cl%C3%ADnica." target="_blank" rel="noopener noreferrer">WhatsApp</a></nav></div></header>
<main>
...
<h1>Como uma clínica odontológica pode reduzir faltas e preencher agenda com IA.</h1>
<p className="lp-lead">Aqui mostramos a lógica por tras de um case de saúde em que agenda, confirmação e reativação passaram a operar com muito mais previsibilidade.</p>
<div className="lp-hero-actions"><a className="lp-btn" href="https://wa.me/5535998491017?text=Vi+o+case+da+cl%C3%ADnica+odontol%C3%B3gica+e+quero+montar+essa+estrutura+de+agenda+e+reativa%C3%A7%C3%A3o+na+minha+cl%C3%ADnica." target="_blank" rel="noopener noreferrer">Quero esse modelo na minha clínica</a><a className="lp-btn-secondary" href="#solucao">Ver a estrutura</a></div>
...
<article className="showcase-signal lp-reveal"><strong>R$0</strong><span>recepcionista extra</span>
...
<h2 className="lp-section-title">A clínica sofria com rotina manual demais.</h2>
...
<p className="lp-section-sub">O resultado veio de processo e memória operacional.</p></div>
...
<h3>S.Y.N.A.P.S.E. para Case de saúde</h3>
...
<div className="lp-hero-actions" style={{marginTop:"24px"}}><a className="lp-btn" href="https://wa.me/5535998491017?text=Vi+o+case+da+cl%C3%ADnica+odontol%C3%B3gica+e+quero+montar+essa+estrutura+de+agenda+e+reativa%C3%A7%C3%A3o+na+minha+cl%C3%ADnica." target="_blank" rel="noopener noreferrer">Quero esse modelo na minha clínica</a></div></article></div></section>
