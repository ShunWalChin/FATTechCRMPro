...
// Transcrita do site original (lp/case-imobiliaria-regional.html) por scripts/transcribe-site.py.
// Conteudo e marcacao sao os do original; o que mudou foi apenas a stack em volta.
export const metadata:Metadata={title:"Como uma imobili\u00e1ria regional pode qualificar mais leads e agendar mais visitas com IA. | FAT Tech",description:"Case imobiliario. Este case demonstra como uma opera\u00e7\u00e3o imobili\u00e1ria ganha velocidade quando o primeiro atendimento e a triagem deixam de depender de corretor ",alternates:{canonical:"https://fattech.com.br/lp/case-imobiliaria-regional"},robots:{index:true,follow:true},twitter:{card:"summary_large_image",title:"Como uma imobili\u00e1ria regional pode qualificar mais leads e agendar mais visitas com IA. | FAT Tech",description:"Case imobiliario. Este case demonstra como uma opera\u00e7\u00e3o imobili\u00e1ria ganha velocidade quando o primeiro atendimento e a triagem deixam de depender de corretor",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"]},openGraph:{title:"Como uma imobili\u00e1ria regional pode qualificar mais leads e agendar mais visitas com IA. | FAT Tech",description:"Case imobiliario. Este case demonstra como uma opera\u00e7\u00e3o imobili\u00e1ria ganha velocidade quando o primeiro atendimento e a triagem deixam de depender de corretor",type:"website",locale:"pt_BR",siteName:"FAT Tech",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"],url:"https://fattech.com.br/lp/case-imobiliaria-regional"}};
...
<div className="lp-nav-inner"><a className="lp-brand" href="/" aria-label="Voltar para a home da FAT Tech"><img src="/dist/Logo_FATTech_Nova-B-ZGug9A.png" alt="Logo FAT Tech - Case imobiliario" style={{width:"52px",height:"52px",objectFit:"contain",filter:"drop-shadow(0 0 18px rgba(0,240,255,.18))"}} />
<div>
<div className="lp-brand-mark">FAT Tech</div>
<div className="lp-brand-meta">Case imobiliario</div></div></a>
<nav className="lp-nav-links" aria-label="Atalhos da landing page"><a href="/">Site Principal</a><a href="/crm.html">CRM IA</a><a href="#preco">Investimento</a><a href="https://wa.me/5535998491017?text=Vi+o+case+da+imobili%C3%A1ria+regional+e+quero+estruturar+qualifica%C3%A7%C3%A3o+e+visitas+com+IA+na+minha+opera%C3%A7%C3%A3o." target="_blank" rel="noopener noreferrer">WhatsApp</a></nav></div></header>
<main>
...
<h1>Como uma imobiliária regional pode qualificar mais leads e agendar mais visitas com IA.</h1>
<p className="lp-lead">Este case demonstra como uma operação imobiliária ganha velocidade quando o primeiro atendimento e a triagem deixam de depender de corretor respondendo tudo manualmente.</p>
<div className="lp-hero-actions"><a className="lp-btn" href="https://wa.me/5535998491017?text=Vi+o+case+da+imobili%C3%A1ria+regional+e+quero+estruturar+qualifica%C3%A7%C3%A3o+e+visitas+com+IA+na+minha+opera%C3%A7%C3%A3o." target="_blank" rel="noopener noreferrer">Quero esse modelo imobiliario</a><a className="lp-btn-secondary" href="#solucao">Ver a estrutura</a></div>
...
<article className="showcase-signal lp-reveal"><strong>24/7</strong><span>atendimento ativo</span>
...
<h2 className="lp-section-title">O estoque existia. O gargalo era o atendimento.</h2>
...
<p className="lp-section-sub">Os corretores entram na etapa nobre da venda com menos ruido na entrada.</p></div>
...
<h3>S.Y.N.A.P.S.E. para Case imobiliario</h3>
...
<div className="lp-hero-actions" style={{marginTop:"24px"}}><a className="lp-btn" href="https://wa.me/5535998491017?text=Vi+o+case+da+imobili%C3%A1ria+regional+e+quero+estruturar+qualifica%C3%A7%C3%A3o+e+visitas+com+IA+na+minha+opera%C3%A7%C3%A3o." target="_blank" rel="noopener noreferrer">Quero esse modelo imobiliario</a></div></article></div></section>
