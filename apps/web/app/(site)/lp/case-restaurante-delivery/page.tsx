...
// Transcrita do site original (lp/case-restaurante-delivery.html) por scripts/transcribe-site.py.
// Conteudo e marcacao sao os do original; o que mudou foi apenas a stack em volta.
export const metadata:Metadata={title:"Como um restaurante com delivery pode vender mais e reter clientes usando IA no WhatsApp. | FAT Tech",description:"Case food service. Este case mostra como um neg\u00f3cio de food service conseguiu acelerar atendimento, aumentar recorr\u00eancia e criar um canal mais inteligente par",alternates:{canonical:"https://fattech.com.br/lp/case-restaurante-delivery"},robots:{index:true,follow:true},twitter:{card:"summary_large_image",title:"Como um restaurante com delivery pode vender mais e reter clientes usando IA no WhatsApp. | FAT Tech",description:"Case food service. Este case mostra como um neg\u00f3cio de food service conseguiu acelerar atendimento, aumentar recorr\u00eancia e criar um canal mais inteligente par",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"]},openGraph:{title:"Como um restaurante com delivery pode vender mais e reter clientes usando IA no WhatsApp. | FAT Tech",description:"Case food service. Este case mostra como um neg\u00f3cio de food service conseguiu acelerar atendimento, aumentar recorr\u00eancia e criar um canal mais inteligente par",type:"website",locale:"pt_BR",siteName:"FAT Tech",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"],url:"https://fattech.com.br/lp/case-restaurante-delivery"}};
...
<div className="lp-nav-inner"><a className="lp-brand" href="/" aria-label="Voltar para a home da FAT Tech"><img src="/dist/Logo_FATTech_Nova-B-ZGug9A.png" alt="Logo FAT Tech - Case food service" style={{width:"52px",height:"52px",objectFit:"contain",filter:"drop-shadow(0 0 18px rgba(0,240,255,.18))"}} />
<div>
<div className="lp-brand-mark">FAT Tech</div>
<div className="lp-brand-meta">Case food service</div></div></a>
<nav className="lp-nav-links" aria-label="Atalhos da landing page"><a href="/">Site Principal</a><a href="/crm.html">CRM IA</a><a href="#preco">Investimento</a><a href="https://wa.me/5535998491017?text=Vi+o+case+de+restaurante+e+delivery+e+quero+montar+essa+estrutura+de+atendimento+e+recorr%C3%AAncia+no+meu+neg%C3%B3cio." target="_blank" rel="noopener noreferrer">WhatsApp</a></nav></div></header>
<main>
...
<h1>Como um restaurante com delivery pode vender mais e reter clientes usando IA no WhatsApp.</h1>
<p className="lp-lead">Este case mostra como um negócio de food service conseguiu acelerar atendimento, aumentar recorrência e criar um canal mais inteligente para pedidos e relacionamento.</p>
<div className="lp-hero-actions"><a className="lp-btn" href="https://wa.me/5535998491017?text=Vi+o+case+de+restaurante+e+delivery+e+quero+montar+essa+estrutura+de+atendimento+e+recorr%C3%AAncia+no+meu+neg%C3%B3cio." target="_blank" rel="noopener noreferrer">Quero esse modelo no meu restaurante</a><a className="lp-btn-secondary" href="#solucao">Ver a estrutura</a></div>
...
<h2 className="lp-section-title">O restaurante respondia muito e vendia menos do que podia.</h2>
...
<h3>S.Y.N.A.P.S.E. para Case food service</h3>
...
<div className="lp-hero-actions" style={{marginTop:"24px"}}><a className="lp-btn" href="https://wa.me/5535998491017?text=Vi+o+case+de+restaurante+e+delivery+e+quero+montar+essa+estrutura+de+atendimento+e+recorr%C3%AAncia+no+meu+neg%C3%B3cio." target="_blank" rel="noopener noreferrer">Quero esse modelo no meu restaurante</a></div></article></div></section>
