...
// Transcrita do site original (lp/veiculos.html) por scripts/transcribe-site.py.
// Conteudo e marcacao sao os do original; o que mudou foi apenas a stack em volta.
export const metadata:Metadata={title:"Sua revendedora respondendo estoque, agendando test drives e recuperando leads no automatico. | FAT Tech",description:"Automotivo com IA. A FAT Tech implanta uma opera\u00e7\u00e3o comercial para o segmento automotivo com atendimento, triagem e follow-up em cima do WhatsApp Oficial.",alternates:{canonical:"https://fattech.com.br/lp/veiculos"},robots:{index:true,follow:true},twitter:{card:"summary_large_image",title:"Sua revendedora respondendo estoque, agendando test drives e recuperando leads no automatico. | FAT Tech",description:"Automotivo com IA. A FAT Tech implanta uma opera\u00e7\u00e3o comercial para o segmento automotivo com atendimento, triagem e follow-up em cima do WhatsApp Oficial.",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"]},openGraph:{title:"Sua revendedora respondendo estoque, agendando test drives e recuperando leads no automatico. | FAT Tech",description:"Automotivo com IA. A FAT Tech implanta uma opera\u00e7\u00e3o comercial para o segmento automotivo com atendimento, triagem e follow-up em cima do WhatsApp Oficial.",type:"website",locale:"pt_BR",siteName:"FAT Tech",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"],url:"https://fattech.com.br/lp/veiculos"}};
...
<div className="lp-nav-inner"><a className="lp-brand" href="/" aria-label="Voltar para a home da FAT Tech"><img src="/dist/Logo_FATTech_Nova-B-ZGug9A.png" alt="Logo FAT Tech - Automotivo com IA" style={{width:"52px",height:"52px",objectFit:"contain",filter:"drop-shadow(0 0 18px rgba(0,240,255,.18))"}} />
<div>
<div className="lp-brand-mark">FAT Tech</div>
<div className="lp-brand-meta">Automotivo com IA</div></div></a>
<nav className="lp-nav-links" aria-label="Atalhos da landing page"><a href="/">Site Principal</a><a href="/crm.html">CRM IA</a><a href="#preco">Investimento</a><a href="https://wa.me/5535998491017?text=Tenho+uma+revendedora+ou+concessionaria+e+quero+automatizar+estoque%2C+test+drive+e+follow-up+de+leads+com+IA." target="_blank" rel="noopener noreferrer">WhatsApp</a></nav></div></header>
<main>
...
<h1>Sua revendedora respondendo estoque, agendando test drives e recuperando leads no automatico.</h1>
<p className="lp-lead">A FAT Tech implanta uma operação comercial para o segmento automotivo com atendimento, triagem e follow-up em cima do WhatsApp Oficial.</p>
<div className="lp-hero-actions"><a className="lp-btn" href="https://wa.me/5535998491017?text=Tenho+uma+revendedora+ou+concessionaria+e+quero+automatizar+estoque%2C+test+drive+e+follow-up+de+leads+com+IA." target="_blank" rel="noopener noreferrer">Quero aplicar na minha revendedora</a><a className="lp-btn-secondary" href="#solucao">Ver a estrutura</a></div>
<div className="showcase-radar">
<article className="showcase-signal lp-reveal"><strong>+16%</strong><span>test drives</span>
<p>Sem uma esteira clara, a equipe responde de forma desigual e perde contexto.</p></article>
<article className="showcase-signal lp-reveal"><strong>-15%</strong><span>tempo de negociação</span>
<p>Contatos bons e frios se misturam, drenando tempo e energia comercial.</p></article>
<article className="showcase-signal lp-reveal"><strong>12%</strong><span>leads recuperados</span>
...
<h2 className="lp-section-title">Lead automotivo desiste quando o atendimento demora.</h2>
...
<p className="lp-section-sub">A operação ganha velocidade comercial e disciplina de acompanhamento.</p></div>
...
<h3>S.Y.N.A.P.S.E. para Automotivo com IA</h3>
