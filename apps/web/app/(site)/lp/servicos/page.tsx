...
// Transcrita do site original (lp/servicos.html) por scripts/transcribe-site.py.
// Conteudo e marcacao sao os do original; o que mudou foi apenas a stack em volta.
export const metadata:Metadata={title:"Seu neg\u00f3cio de servi\u00e7os operando agenda, or\u00e7amentos e reativa\u00e7\u00e3o de clientes com IA. | FAT Tech",description:"Servi\u00e7os com IA. A FAT Tech implanta uma estrutura comercial que recebe o pedido, qualifica a demanda, agenda e acompanha or\u00e7amentos sem depender de planilha.",alternates:{canonical:"https://fattech.com.br/lp/servicos"},robots:{index:true,follow:true},twitter:{card:"summary_large_image",title:"Seu neg\u00f3cio de servi\u00e7os operando agenda, or\u00e7amentos e reativa\u00e7\u00e3o de clientes com IA. | FAT Tech",description:"Servi\u00e7os com IA. A FAT Tech implanta uma estrutura comercial que recebe o pedido, qualifica a demanda, agenda e acompanha or\u00e7amentos sem depender de planilha.",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"]},openGraph:{title:"Seu neg\u00f3cio de servi\u00e7os operando agenda, or\u00e7amentos e reativa\u00e7\u00e3o de clientes com IA. | FAT Tech",description:"Servi\u00e7os com IA. A FAT Tech implanta uma estrutura comercial que recebe o pedido, qualifica a demanda, agenda e acompanha or\u00e7amentos sem depender de planilha.",type:"website",locale:"pt_BR",siteName:"FAT Tech",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"],url:"https://fattech.com.br/lp/servicos"}};
...
<div className="lp-nav-inner"><a className="lp-brand" href="/" aria-label="Voltar para a home da FAT Tech"><img src="/dist/Logo_FATTech_Nova-B-ZGug9A.png" alt="Logo FAT Tech - Servi\u00e7os com IA" style={{width:"52px",height:"52px",objectFit:"contain",filter:"drop-shadow(0 0 18px rgba(0,240,255,.18))"}} />
<div>
<div className="lp-brand-mark">FAT Tech</div>
<div className="lp-brand-meta">Serviços com IA</div></div></a>
<nav className="lp-nav-links" aria-label="Atalhos da landing page"><a href="/">Site Principal</a><a href="/crm.html">CRM IA</a><a href="#preco">Investimento</a><a href="https://wa.me/5535998491017?text=Tenho+um+neg%C3%B3cio+de+servi%C3%A7os+e+quero+automatizar+agenda%2C+or%C3%A7amentos+e+follow-up+com+IA." target="_blank" rel="noopener noreferrer">WhatsApp</a></nav></div></header>
<main>
...
<h1>Seu negócio de serviços operando agenda, orçamentos e reativação de clientes com IA.</h1>
<p className="lp-lead">A FAT Tech implanta uma estrutura comercial que recebe o pedido, qualifica a demanda, agenda e acompanha orçamentos sem depender de planilha.</p>
<div className="lp-hero-actions"><a className="lp-btn" href="https://wa.me/5535998491017?text=Tenho+um+neg%C3%B3cio+de+servi%C3%A7os+e+quero+automatizar+agenda%2C+or%C3%A7amentos+e+follow-up+com+IA." target="_blank" rel="noopener noreferrer">Quero aplicar no meu negócio</a><a className="lp-btn-secondary" href="#solucao">Ver a estrutura</a></div>
...
<article className="showcase-signal lp-reveal"><strong>+12%</strong><span>retorno em propostas</span>
<p>Contatos bons e frios se misturam, drenando tempo e energia comercial.</p></article>
<article className="showcase-signal lp-reveal"><strong>-18%</strong><span>tempo no atendimento</span>
...
<h2 className="lp-section-title">Prestador perde negócio no meio do processo.</h2>
...
<p className="lp-section-sub">A empresa deixa de atuar no improviso e passa a ter memória.</p></div>
...
<h3>S.Y.N.A.P.S.E. para Serviços com IA</h3>
...
<div className="lp-hero-actions" style={{marginTop:"24px"}}><a className="lp-btn" href="https://wa.me/5535998491017?text=Tenho+um+neg%C3%B3cio+de+servi%C3%A7os+e+quero+automatizar+agenda%2C+or%C3%A7amentos+e+follow-up+com+IA." target="_blank" rel="noopener noreferrer">Quero aplicar no meu negócio</a></div></article></div></section>
