...
// Transcrita do site original (lp/clinicas.html) por scripts/transcribe-site.py.
// Conteudo e marcacao sao os do original; o que mudou foi apenas a stack em volta.
export const metadata:Metadata={title:"Sua cl\u00ednica reduzindo faltas e ganhando agenda organizada com IA no WhatsApp. | FAT Tech",description:"Cl\u00ednicas com IA. A FAT Tech implanta um fluxo para cl\u00ednicas que confirma consultas, reage cancelamentos e reengaja pacientes com muito menos dependencia de re",alternates:{canonical:"https://fattech.com.br/lp/clinicas"},robots:{index:true,follow:true},twitter:{card:"summary_large_image",title:"Sua cl\u00ednica reduzindo faltas e ganhando agenda organizada com IA no WhatsApp. | FAT Tech",description:"Cl\u00ednicas com IA. A FAT Tech implanta um fluxo para cl\u00ednicas que confirma consultas, reage cancelamentos e reengaja pacientes com muito menos dependencia de re",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"]},openGraph:{title:"Sua cl\u00ednica reduzindo faltas e ganhando agenda organizada com IA no WhatsApp. | FAT Tech",description:"Cl\u00ednicas com IA. A FAT Tech implanta um fluxo para cl\u00ednicas que confirma consultas, reage cancelamentos e reengaja pacientes com muito menos dependencia de re",type:"website",locale:"pt_BR",siteName:"FAT Tech",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"],url:"https://fattech.com.br/lp/clinicas"}};
...
<div className="lp-nav-inner"><a className="lp-brand" href="/" aria-label="Voltar para a home da FAT Tech"><img src="/dist/Logo_FATTech_Nova-B-ZGug9A.png" alt="Logo FAT Tech - Cl\u00ednicas com IA" style={{width:"52px",height:"52px",objectFit:"contain",filter:"drop-shadow(0 0 18px rgba(0,240,255,.18))"}} />
<div>
<div className="lp-brand-mark">FAT Tech</div>
<div className="lp-brand-meta">Clínicas com IA</div></div></a>
<nav className="lp-nav-links" aria-label="Atalhos da landing page"><a href="/">Site Principal</a><a href="/crm.html">CRM IA</a><a href="#preco">Investimento</a><a href="https://wa.me/5535998491017?text=Tenho+uma+cl%C3%ADnica+e+quero+automatizar+agenda%2C+confirmacoes+e+reativa%C3%A7%C3%A3o+de+pacientes+com+IA+no+WhatsApp." target="_blank" rel="noopener noreferrer">WhatsApp</a></nav></div></header>
<main>
...
<h1>Sua clínica reduzindo faltas e ganhando agenda organizada com IA no WhatsApp.</h1>
<p className="lp-lead">A FAT Tech implanta um fluxo para clínicas que confirma consultas, reage cancelamentos e reengaja pacientes com muito menos dependencia de recepção manual.</p>
<div className="lp-hero-actions"><a className="lp-btn" href="https://wa.me/5535998491017?text=Tenho+uma+cl%C3%ADnica+e+quero+automatizar+agenda%2C+confirmacoes+e+reativa%C3%A7%C3%A3o+de+pacientes+com+IA+no+WhatsApp." target="_blank" rel="noopener noreferrer">Quero ativar na minha clínica</a><a className="lp-btn-secondary" href="#solucao">Ver a estrutura</a></div>
<div className="showcase-radar">
<article className="showcase-signal lp-reveal"><strong>-18%</strong><span>faltas</span>
<p>Sem uma esteira clara, a equipe responde de forma desigual e perde contexto.</p></article>
<article className="showcase-signal lp-reveal"><strong>+15%</strong><span>mais agendamentos</span>
<p>Contatos bons e frios se misturam, drenando tempo e energia comercial.</p></article>
<article className="showcase-signal lp-reveal"><strong>24/7</strong><span>respostas</span>
...
<h2 className="lp-section-title">Recepção sobrecarregada derruba experiência e faturamento.</h2>
...
<p className="lp-section-sub">A agenda deixa de ser passiva e passa a ser um sistema ativo de ocupação.</p></div>
...
<h3>S.Y.N.A.P.S.E. para Clínicas com IA</h3>
...
<div className="lp-hero-actions" style={{marginTop:"24px"}}><a className="lp-btn" href="https://wa.me/5535998491017?text=Tenho+uma+cl%C3%ADnica+e+quero+automatizar+agenda%2C+confirmacoes+e+reativa%C3%A7%C3%A3o+de+pacientes+com+IA+no+WhatsApp." target="_blank" rel="noopener noreferrer">Quero ativar na minha clínica</a></div></article></div></section>
