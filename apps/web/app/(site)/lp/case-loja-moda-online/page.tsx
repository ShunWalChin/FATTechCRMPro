...
// Transcrita do site original (lp/case-loja-moda-online.html) por scripts/transcribe-site.py.
// Conteudo e marcacao sao os do original; o que mudou foi apenas a stack em volta.
export const metadata:Metadata={title:"Como uma loja de moda online pode transformar carrinho abandonado em receita previsivel. | FAT Tech",description:"Case de varejo digital. Esta LP mostra a arquitetura comercial que levou uma opera\u00e7\u00e3o de varejo digital a recuperar carrinhos e elevar recorr\u00eancia com IA.",alternates:{canonical:"https://fattech.com.br/lp/case-loja-moda-online"},robots:{index:true,follow:true},twitter:{card:"summary_large_image",title:"Como uma loja de moda online pode transformar carrinho abandonado em receita previsivel. | FAT Tech",description:"Case de varejo digital. Esta LP mostra a arquitetura comercial que levou uma opera\u00e7\u00e3o de varejo digital a recuperar carrinhos e elevar recorr\u00eancia com IA.",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"]},openGraph:{title:"Como uma loja de moda online pode transformar carrinho abandonado em receita previsivel. | FAT Tech",description:"Case de varejo digital. Esta LP mostra a arquitetura comercial que levou uma opera\u00e7\u00e3o de varejo digital a recuperar carrinhos e elevar recorr\u00eancia com IA.",type:"website",locale:"pt_BR",siteName:"FAT Tech",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"],url:"https://fattech.com.br/lp/case-loja-moda-online"}};
...
<div className="lp-nav-inner"><a className="lp-brand" href="/" aria-label="Voltar para a home da FAT Tech"><img src="/dist/Logo_FATTech_Nova-B-ZGug9A.png" alt="Logo FAT Tech - Case de varejo digital" style={{width:"52px",height:"52px",objectFit:"contain",filter:"drop-shadow(0 0 18px rgba(0,240,255,.18))"}} />
<div>
<div className="lp-brand-mark">FAT Tech</div>
<div className="lp-brand-meta">Case de varejo digital</div></div></a>
<nav className="lp-nav-links" aria-label="Atalhos da landing page"><a href="/">Site Principal</a><a href="/crm.html">CRM IA</a><a href="#preco">Investimento</a><a href="https://wa.me/5535998491017?text=Vi+o+case+da+loja+de+moda+online+e+quero+aplicar+essa+estrutura+de+recuperacao+e+recorr%C3%AAncia+no+meu+neg%C3%B3cio." target="_blank" rel="noopener noreferrer">WhatsApp</a></nav></div></header>
<main>
...
<h1>Como uma loja de moda online pode transformar carrinho abandonado em receita previsivel.</h1>
<p className="lp-lead">Esta LP mostra a arquitetura comercial que levou uma operação de varejo digital a recuperar carrinhos e elevar recorrência com IA.</p>
<div className="lp-hero-actions"><a className="lp-btn" href="https://wa.me/5535998491017?text=Vi+o+case+da+loja+de+moda+online+e+quero+aplicar+essa+estrutura+de+recuperacao+e+recorr%C3%AAncia+no+meu+neg%C3%B3cio." target="_blank" rel="noopener noreferrer">Quero esse motor comercial</a><a className="lp-btn-secondary" href="#solucao">Ver a estrutura</a></div>
...
<article className="showcase-signal lp-reveal"><strong>-12%</strong><span>CAC</span>
<p>Contatos bons e frios se misturam, drenando tempo e energia comercial.</p></article>
<article className="showcase-signal lp-reveal"><strong>14%</strong><span>recuperacao</span>
...
<h2 className="lp-section-title">A loja já tinha tráfego. O vazamento estava no meio do funil.</h2>
...
<p className="lp-section-sub">A estrutura pode ser replicada em outros varejos digitais.</p></div>
...
<h3>S.Y.N.A.P.S.E. para Case de varejo digital</h3>
...
<div className="lp-hero-actions" style={{marginTop:"24px"}}><a className="lp-btn" href="https://wa.me/5535998491017?text=Vi+o+case+da+loja+de+moda+online+e+quero+aplicar+essa+estrutura+de+recuperacao+e+recorr%C3%AAncia+no+meu+neg%C3%B3cio." target="_blank" rel="noopener noreferrer">Quero esse motor comercial</a></div></article></div></section>
