...
// Transcrita do site original (lp/imobiliarias.html) por scripts/transcribe-site.py.
// Conteudo e marcacao sao os do original; o que mudou foi apenas a stack em volta.
export const metadata:Metadata={title:"Imobili\u00e1rias com IA: atenda, qualifique e agende 24/7 | FAT Tech",description:"Operador comercial com IA no WhatsApp Oficial para sua imobili\u00e1ria: responde sobre im\u00f3veis, qualifica leads, envia op\u00e7\u00f5es certas e agenda visitas 24/7.",alternates:{canonical:"https://fattech.com.br/lp/imobiliarias"},robots:{index:true,follow:true},twitter:{card:"summary_large_image",title:"Imobili\u00e1rias com IA: atenda, qualifique e agende 24/7 | FAT Tech",description:"Operador comercial com IA no WhatsApp Oficial para sua imobili\u00e1ria: responde sobre im\u00f3veis, qualifica leads, envia op\u00e7\u00f5es certas e agenda visitas 24/7.",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"]},openGraph:{title:"Imobili\u00e1rias com IA: atenda, qualifique e agende 24/7 | FAT Tech",description:"Operador comercial com IA no WhatsApp Oficial para sua imobili\u00e1ria: responde sobre im\u00f3veis, qualifica leads, envia op\u00e7\u00f5es certas e agenda visitas 24/7.",type:"website",locale:"pt_BR",siteName:"FAT Tech",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"],url:"https://fattech.com.br/lp/imobiliarias"}};
...
<div className="lp-nav-inner"><a className="lp-brand" href="/" aria-label="Voltar para a home da FAT Tech"><img src="/dist/Logo_FATTech_Nova-B-ZGug9A.png" alt="Logo FAT Tech - Imobili\u00e1rias com IA" style={{width:"52px",height:"52px",objectFit:"contain",filter:"drop-shadow(0 0 18px rgba(0,240,255,.18))"}} />
<div>
<div className="lp-brand-mark">FAT Tech</div>
<div className="lp-brand-meta">Imobiliárias com IA</div></div></a>
<nav className="lp-nav-links" aria-label="Atalhos da landing page"><a href="/">Site Principal</a><a href="/crm.html">CRM IA</a><a href="#preco">Investimento</a><a href="https://wa.me/5535998491017?text=Tenho+uma+imobili%C3%A1ria+e+quero+entender+como+a+FAT+Tech+pode+implantar+essa+opera%C3%A7%C3%A3o+com+IA+no+meu+atendimento+e+nas+minhas+visitas." target="_blank" rel="noopener noreferrer">WhatsApp</a></nav></div></header>
<main>
...
<h1>Sua imobiliária atendendo, qualificando e agendando visitas 24/7.</h1>
<p className="lp-lead">A FAT Tech implanta um operador comercial no WhatsApp Oficial para responder sobre imóveis, separar leads quentes, enviar opções certas e agendar visitas.</p>
<div className="lp-hero-actions"><a className="lp-btn" href="https://wa.me/5535998491017?text=Tenho+uma+imobili%C3%A1ria+e+quero+entender+como+a+FAT+Tech+pode+implantar+essa+opera%C3%A7%C3%A3o+com+IA+no+meu+atendimento+e+nas+minhas+visitas." target="_blank" rel="noopener noreferrer">Quero ativar na minha imobiliária</a><a className="lp-btn-secondary" href="#solucao">Ver a estrutura</a></div>
...
<article className="showcase-signal lp-reveal"><strong>+12%</strong><span>mais visitas</span>
<p>Contatos bons e frios se misturam, drenando tempo e energia comercial.</p></article>
<article className="showcase-signal lp-reveal"><strong>+15%</strong><span>leads qualificados</span>
...
<h2 className="lp-section-title">O lead imobiliario esfria muito rápido.</h2>
...
<p className="lp-section-sub">Menos vazamento e mais velocidade para o corretor.</p></div>
...
<h3>S.Y.N.A.P.S.E. para Imobiliárias com IA</h3>
...
<div className="lp-hero-actions" style={{marginTop:"24px"}}><a className="lp-btn" href="https://wa.me/5535998491017?text=Tenho+uma+imobili%C3%A1ria+e+quero+entender+como+a+FAT+Tech+pode+implantar+essa+opera%C3%A7%C3%A3o+com+IA+no+meu+atendimento+e+nas+minhas+visitas." target="_blank" rel="noopener noreferrer">Quero ativar na minha imobiliária</a></div></article></div></section>
