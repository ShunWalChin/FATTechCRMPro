...
// Transcrita do site original (lp/construcao.html) por scripts/transcribe-site.py.
// Conteudo e marcacao sao os do original; o que mudou foi apenas a stack em volta.
export const metadata:Metadata={title:"Sua construtora qualificando leads e organizando atendimento comercial sem vazamento. | FAT Tech",description:"Constru\u00e7\u00e3o com IA. A FAT Tech implanta uma opera\u00e7\u00e3o de IA para constru\u00e7\u00e3o e incorpora\u00e7\u00e3o que atende interessados, filtra perfil e sustenta o relacionamento co",alternates:{canonical:"https://fattech.com.br/lp/construcao"},robots:{index:true,follow:true},twitter:{card:"summary_large_image",title:"Sua construtora qualificando leads e organizando atendimento comercial sem vazamento. | FAT Tech",description:"Constru\u00e7\u00e3o com IA. A FAT Tech implanta uma opera\u00e7\u00e3o de IA para constru\u00e7\u00e3o e incorpora\u00e7\u00e3o que atende interessados, filtra perfil e sustenta o relacionamento co",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"]},openGraph:{title:"Sua construtora qualificando leads e organizando atendimento comercial sem vazamento. | FAT Tech",description:"Constru\u00e7\u00e3o com IA. A FAT Tech implanta uma opera\u00e7\u00e3o de IA para constru\u00e7\u00e3o e incorpora\u00e7\u00e3o que atende interessados, filtra perfil e sustenta o relacionamento co",type:"website",locale:"pt_BR",siteName:"FAT Tech",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"],url:"https://fattech.com.br/lp/construcao"}};
...
<div className="lp-nav-inner"><a className="lp-brand" href="/" aria-label="Voltar para a home da FAT Tech"><img src="/dist/Logo_FATTech_Nova-B-ZGug9A.png" alt="Logo FAT Tech - Constru\u00e7\u00e3o com IA" style={{width:"52px",height:"52px",objectFit:"contain",filter:"drop-shadow(0 0 18px rgba(0,240,255,.18))"}} />
<div>
<div className="lp-brand-mark">FAT Tech</div>
<div className="lp-brand-meta">Construção com IA</div></div></a>
<nav className="lp-nav-links" aria-label="Atalhos da landing page"><a href="/">Site Principal</a><a href="/crm.html">CRM IA</a><a href="#preco">Investimento</a><a href="https://wa.me/5535998491017?text=Sou+do+setor+de+constru%C3%A7%C3%A3o+e+quero+estruturar+capta%C3%A7%C3%A3o%2C+qualifica%C3%A7%C3%A3o+e+atendimento+comercial+com+IA." target="_blank" rel="noopener noreferrer">WhatsApp</a></nav></div></header>
<main>
<section className="lp-section lp-section--hero">
<div className="lp-section-inner lp-hero">
<div className="lp-reveal">
<div className="lp-kicker">IA aplicada ao seu segmento</div>
<h1>Sua construtora qualificando leads e organizando atendimento comercial sem vazamento.</h1>
<p className="lp-lead">A FAT Tech implanta uma operação de IA para construção e incorporação que atende interessados, filtra perfil e sustenta o relacionamento comercial.</p>
<div className="lp-hero-actions"><a className="lp-btn" href="https://wa.me/5535998491017?text=Sou+do+setor+de+constru%C3%A7%C3%A3o+e+quero+estruturar+capta%C3%A7%C3%A3o%2C+qualifica%C3%A7%C3%A3o+e+atendimento+comercial+com+IA." target="_blank" rel="noopener noreferrer">Quero aplicar na minha construtora</a><a className="lp-btn-secondary" href="#solucao">Ver a estrutura</a></div>
<div className="showcase-radar">
<article className="showcase-signal lp-reveal"><strong>+16%</strong><span>leads aproveitados</span>
<p>Sem uma esteira clara, a equipe responde de forma desigual e perde contexto.</p></article>
<article className="showcase-signal lp-reveal"><strong>24/7</strong><span>primeira resposta</span>
<p>Contatos bons e frios se misturam, drenando tempo e energia comercial.</p></article>
<article className="showcase-signal lp-reveal"><strong>-18%</strong><span>tempo administrativo</span>
...
<div className="showcase-cta-strip"><a href="#dor">O que mais pesa nesse mercado hoje</a><a href="#preco">Ver investimento</a></div></aside></div></section>
<section className="lp-section" id="dor">
<div className="lp-section-inner">
<div className="lp-section-header lp-reveal">
<div className="lp-kicker">O que mais pesa nesse mercado hoje</div>
<h2 className="lp-section-title">Construção vende em ciclos longos e exige memória demais.</h2>
...
<div className="lp-section-inner">
<div className="lp-section-header lp-reveal">
<div className="lp-kicker">Como a FAT Tech entra nessa jornada</div>
...
<div className="lp-section-inner">
<div className="lp-section-header lp-reveal">
<div className="lp-kicker">O que esse tipo de operação muda</div>
<h2 className="lp-section-title">O que muda quando processo e IA entram juntos.</h2>
<p className="lp-section-sub">Mais clareza comercial, menos vazamento e operação mais profissional.</p></div>
...
<div className="lp-section-inner">
<div className="lp-section-header lp-reveal">
<div className="lp-kicker">O que sua marca passa a vender junto com a oferta</div>
<h2 className="lp-section-title">Você não vende só serviço ou produto. Vende clareza, ritmo, segurança e sensação de que existe um processo maduro por trás da conversa.</h2>
...
<h3>S.Y.N.A.P.S.E. para Construção com IA</h3>
...
<div className="lp-hero-actions" style={{marginTop:"24px"}}><a className="lp-btn" href="https://wa.me/5535998491017?text=Sou+do+setor+de+constru%C3%A7%C3%A3o+e+quero+estruturar+capta%C3%A7%C3%A3o%2C+qualifica%C3%A7%C3%A3o+e+atendimento+comercial+com+IA." target="_blank" rel="noopener noreferrer">Quero aplicar na minha construtora</a></div></article></div></section>
