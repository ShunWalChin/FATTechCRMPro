...
// Transcrita do site original (lp/restaurantes.html) por scripts/transcribe-site.py.
// Conteudo e marcacao sao os do original; o que mudou foi apenas a stack em volta.
export const metadata:Metadata={title:"Seu restaurante atendendo reservas, pedidos e reativa\u00e7\u00e3o sem depender do vai-e-vem manual. | FAT Tech",description:"Restaurantes com IA. A FAT Tech implanta um fluxo no WhatsApp para restaurantes e delivery que organiza pedidos, reservas e retorno de clientes com linguagem ",alternates:{canonical:"https://fattech.com.br/lp/restaurantes"},robots:{index:true,follow:true},twitter:{card:"summary_large_image",title:"Seu restaurante atendendo reservas, pedidos e reativa\u00e7\u00e3o sem depender do vai-e-vem manual. | FAT Tech",description:"Restaurantes com IA. A FAT Tech implanta um fluxo no WhatsApp para restaurantes e delivery que organiza pedidos, reservas e retorno de clientes com linguagem",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"]},openGraph:{title:"Seu restaurante atendendo reservas, pedidos e reativa\u00e7\u00e3o sem depender do vai-e-vem manual. | FAT Tech",description:"Restaurantes com IA. A FAT Tech implanta um fluxo no WhatsApp para restaurantes e delivery que organiza pedidos, reservas e retorno de clientes com linguagem",type:"website",locale:"pt_BR",siteName:"FAT Tech",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"],url:"https://fattech.com.br/lp/restaurantes"}};
...
<div className="lp-nav-inner"><a className="lp-brand" href="/" aria-label="Voltar para a home da FAT Tech"><img src="/dist/Logo_FATTech_Nova-B-ZGug9A.png" alt="Logo FAT Tech - Restaurantes com IA" style={{width:"52px",height:"52px",objectFit:"contain",filter:"drop-shadow(0 0 18px rgba(0,240,255,.18))"}} />
<div>
<div className="lp-brand-mark">FAT Tech</div>
<div className="lp-brand-meta">Restaurantes com IA</div></div></a>
<nav className="lp-nav-links" aria-label="Atalhos da landing page"><a href="/">Site Principal</a><a href="/crm.html">CRM IA</a><a href="#preco">Investimento</a><a href="https://wa.me/5535998491017?text=Tenho+um+restaurante+e+quero+automatizar+pedidos%2C+reservas+e+fidelizacao+com+IA+no+WhatsApp." target="_blank" rel="noopener noreferrer">WhatsApp</a></nav></div></header>
<main>
...
<h1>Seu restaurante atendendo reservas, pedidos e reativação sem depender do vai-e-vem manual.</h1>
<p className="lp-lead">A FAT Tech implanta um fluxo no WhatsApp para restaurantes e delivery que organiza pedidos, reservas e retorno de clientes com linguagem de marca.</p>
<div className="lp-hero-actions"><a className="lp-btn" href="https://wa.me/5535998491017?text=Tenho+um+restaurante+e+quero+automatizar+pedidos%2C+reservas+e+fidelizacao+com+IA+no+WhatsApp." target="_blank" rel="noopener noreferrer">Quero aplicar no meu restaurante</a><a className="lp-btn-secondary" href="#solucao">Ver a estrutura</a></div>
<div className="showcase-radar">
<article className="showcase-signal lp-reveal"><strong>+14%</strong><span>retencao</span>
<p>Sem uma esteira clara, a equipe responde de forma desigual e perde contexto.</p></article>
<article className="showcase-signal lp-reveal"><strong>+12%</strong><span>pedidos recorrentes</span>
...
<h2 className="lp-section-title">O restaurante perde venda no atrito do atendimento.</h2>
...
<p className="lp-section-sub">Mais recorrência e menos atrito transformam a experiência e a margem.</p></div>
...
<h3>S.Y.N.A.P.S.E. para Restaurantes com IA</h3>
...
<div className="lp-hero-actions" style={{marginTop:"24px"}}><a className="lp-btn" href="https://wa.me/5535998491017?text=Tenho+um+restaurante+e+quero+automatizar+pedidos%2C+reservas+e+fidelizacao+com+IA+no+WhatsApp." target="_blank" rel="noopener noreferrer">Quero aplicar no meu restaurante</a></div></article></div></section>
