...
// Transcrita do site original (lp/advocacia.html) por scripts/transcribe-site.py.
// Conteudo e marcacao sao os do original; o que mudou foi apenas a stack em volta.
export const metadata:Metadata={title:"Seu escrit\u00f3rio filtrando casos, qualificando clientes e lotando a agenda com crit\u00e9rio. | FAT Tech",description:"Advocacia com IA. A FAT Tech transforma o primeiro contato jur\u00eddico em um processo estruturado de triagem, qualifica\u00e7\u00e3o e agenda no WhatsApp.",alternates:{canonical:"https://fattech.com.br/lp/advocacia"},robots:{index:true,follow:true},twitter:{card:"summary_large_image",title:"Seu escrit\u00f3rio filtrando casos, qualificando clientes e lotando a agenda com crit\u00e9rio. | FAT Tech",description:"Advocacia com IA. A FAT Tech transforma o primeiro contato jur\u00eddico em um processo estruturado de triagem, qualifica\u00e7\u00e3o e agenda no WhatsApp.",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"]},openGraph:{title:"Seu escrit\u00f3rio filtrando casos, qualificando clientes e lotando a agenda com crit\u00e9rio. | FAT Tech",description:"Advocacia com IA. A FAT Tech transforma o primeiro contato jur\u00eddico em um processo estruturado de triagem, qualifica\u00e7\u00e3o e agenda no WhatsApp.",type:"website",locale:"pt_BR",siteName:"FAT Tech",images:["https://fattech.com.br/dist/Logo_FATTech_Nova-B-ZGug9A.png"],url:"https://fattech.com.br/lp/advocacia"}};
...
<div className="lp-nav-inner"><a className="lp-brand" href="/" aria-label="Voltar para a home da FAT Tech"><img src="/dist/Logo_FATTech_Nova-B-ZGug9A.png" alt="Logo FAT Tech - Advocacia com IA" style={{width:"52px",height:"52px",objectFit:"contain",filter:"drop-shadow(0 0 18px rgba(0,240,255,.18))"}} />
<div>
<div className="lp-brand-mark">FAT Tech</div>
<div className="lp-brand-meta">Advocacia com IA</div></div></a>
<nav className="lp-nav-links" aria-label="Atalhos da landing page"><a href="/">Site Principal</a><a href="/crm.html">CRM IA</a><a href="#preco">Investimento</a><a href="https://wa.me/5535998491017?text=Tenho+um+escrit%C3%B3rio+de+advocacia+e+quero+estruturar+triagem%2C+agenda+e+qualifica%C3%A7%C3%A3o+de+clientes+com+IA+no+WhatsApp." target="_blank" rel="noopener noreferrer">WhatsApp</a></nav></div></header>
<main>
...
<h1>Seu escritório filtrando casos, qualificando clientes e lotando a agenda com critério.</h1>
<p className="lp-lead">A FAT Tech transforma o primeiro contato jurídico em um processo estruturado de triagem, qualificação e agenda no WhatsApp.</p>
<div className="lp-hero-actions"><a className="lp-btn" href="https://wa.me/5535998491017?text=Tenho+um+escrit%C3%B3rio+de+advocacia+e+quero+estruturar+triagem%2C+agenda+e+qualifica%C3%A7%C3%A3o+de+clientes+com+IA+no+WhatsApp." target="_blank" rel="noopener noreferrer">Quero aplicar no meu escritório</a><a className="lp-btn-secondary" href="#solucao">Ver a estrutura</a></div>
...
<h2 className="lp-section-title">A advocacia perde tempo demais antes da consulta.</h2>
...
<p className="lp-section-sub">A IA cuida da entrada operacional e o advogado entra com mais contexto.</p></div>
...
<h3>S.Y.N.A.P.S.E. para Advocacia com IA</h3>
...
<div className="lp-hero-actions" style={{marginTop:"24px"}}><a className="lp-btn" href="https://wa.me/5535998491017?text=Tenho+um+escrit%C3%B3rio+de+advocacia+e+quero+estruturar+triagem%2C+agenda+e+qualifica%C3%A7%C3%A3o+de+clientes+com+IA+no+WhatsApp." target="_blank" rel="noopener noreferrer">Quero aplicar no meu escritório</a></div></article></div></section>
