...
<style dangerouslySetInnerHTML={{__html:"\n    /* Customiza\u00e7\u00f5es espec\u00edficas da p\u00e1gina de integra\u00e7\u00f5es \u2014 100% aditivo */\n    .integ-hero {\n      padding: 160px 24px 80px;\n      text-align: center;\n      position: relative;\n      overflow: hidden;\n      background:\n        radial-gradient(ellipse at 20% 30%, rgba(0,240,255,0.10), transparent 55%),\n        radial-gradient(ellipse at 80% 60%, rgba(168,85,247,0.08), transparent 55%),\n        var(--bg-base);\n      border-bottom: 1px solid var(--hairline-soft);\n    }\n    .integ-hero h1 {\n      font-family: var(--font-display);\n      font-weight: 400;\n      font-size: clamp(2rem, 5vw, 3.6rem);\n      line-height: 1.15;\n      letter-spacing: 0.01em;\n      color: var(--text);\n      max-width: 880px;\n      margin: 18px auto 18px;\n    }\n    .integ-hero h1 em {\n      font-style: normal;\n      color: var(--cyan);\n    }\n    .integ-hero p {\n      max-width: 640px;\n      margin: 0 auto 32px;\n      color: var(--text-muted);\n      font-size: 1.1rem;\n    }\n\n    .integ-tabs {\n      display: flex;\n      flex-wrap: wrap;\n      justify-content: center;\n      gap: 8px;\n      margin: 48px 0 32px;\n    }\n    .integ-tab {\n      background: transparent;\n      color: var(--text-muted);\n      border: 1px solid var(--border);\n      padding: 8px 16px;\n      border-radius: 9999px;\n      font-family: var(--font-mono);\n      font-size: 0.78rem;\n      letter-spacing: 0.06em;\n      cursor: pointer;\n      transition: var(--transition);\n      text-transform: uppercase;\n    }\n    .integ-tab:hover { border-color: var(--border-hot); color: var(--text); }\n    .integ-tab.active {\n      background: rgba(0,240,255,0.10);\n      color: var(--cyan);\n      border-color: var(--border-hot);\n    }\n\n    .integ-category {\n      margin-top: 56px;\n    }\n    .integ-category h2 {\n      font-family: var(--font-display);\n      font-weight: 400;\n      font-size: 1.6rem;\n      letter-spacing: 0.01em;\n      color: var(--text);\n      margin-bottom: 8px;\n    }\n    .integ-category h2::before {\n      content: '// ';\n      color: var(--cyan);\n      font-family: var(--font-mono);\n      font-size: 0.85em;\n      letter-spacing: 0.1em;\n    }\n    .integ-category p {\n      color: var(--text-muted);\n      max-width: 580px;\n      margin-bottom: 32px;\n    }\n\n    .integ-cta-final {\n      margin-top: 80px;\n    }\n  "}} />
<Script id="s-10432414" src="https://www.googletagmanager.com/gtag/js?id=G-LRDDE0GWT3" strategy="afterInteractive" />
<Script id="i-71923307" strategy="afterInteractive" dangerouslySetInnerHTML={{__html:"\n    window.dataLayer = window.dataLayer || [];\n    function gtag(){dataLayer.push(arguments);}\n    gtag('js', new Date());\n    gtag('config', 'G-LRDDE0GWT3');\n  "}} />{/* Overlays decorativos */}
