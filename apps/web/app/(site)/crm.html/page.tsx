...
<section id="inicio" className="hero" aria-label="FAT Tech CRM IA S.Y.N.A.P.S.E."><canvas id="particleCanvas" aria-hidden="true" suppressHydrationWarning></canvas>
...
<div className="invest-bg"><canvas id="investCanvas" aria-hidden="true" suppressHydrationWarning></canvas>
