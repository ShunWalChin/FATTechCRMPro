...
CAPACIDADES = [
    ...
    ("COMERCIAL/Leads", "Campanha", False, "AUSENTE — utm_campaign fica em attribution, sem vinculo com kind campaigns"),
    ("COMERCIAL/Leads", "UTM", codigo("services.py", "attribution"), "PARCIAL — gravado em data.attribution na captura, nao e campo consultavel"),
    ("COMERCIAL/Leads", "Responsavel", campo("contacts", "owner_id"), "contacts.owner_id"),
    ("COMERCIAL/Leads", "Score", campo("contacts", "score"), "PARCIAL — campo 0..100 existe, nada o calcula"),
    ("COMERCIAL/Leads", "Estagio do lead", campo("contacts", "status"), "PARCIAL — contacts.status tem lead/new/qualified, sem estagio proprio"),
    ("COMERCIAL/Leads", "Ultima interacao", False, "AUSENTE — activities existem, mas o contato nao carrega o instante"),
    ("COMERCIAL/Leads", "Proxima acao", False, "AUSENTE no contato — deals.next_action_at existe, o lead nao tem"),
    ...
    ("COMERCIAL/Leads", "Distribuicao automatica", False, "AUSENTE — owner_id e sempre manual"),

    # ------------------------------------------------------- COMERCIAL > QUALIFICACAO
    ("COMERCIAL/Qualificacao", "Criterios configuraveis", False, "AUSENTE"),
    ("COMERCIAL/Qualificacao", "Lead scoring", False, "AUSENTE — o campo score existe, a regra que o alimenta nao"),
    ("COMERCIAL/Qualificacao", "Classificacao por temperatura", codigo("services.py", "score_band"), "PARCIAL — score_band() classifica oportunidade pela probabilidade, nao lead"),
    ("COMERCIAL/Qualificacao", "ICP", False, "AUSENTE"),
    ("COMERCIAL/Qualificacao", "Fit da empresa", False, "AUSENTE"),
    ("COMERCIAL/Qualificacao", "Intencao de compra", False, "AUSENTE"),
    ("COMERCIAL/Qualificacao", "Orcamento do lead", False, "AUSENTE"),
    ("COMERCIAL/Qualificacao", "Prazo", False, "AUSENTE"),
    ("COMERCIAL/Qualificacao", "Comportamento", False, "AUSENTE"),
    ("COMERCIAL/Qualificacao", "Regras de qualificacao", codigo("services.py", "required_fields"), "PARCIAL — campos obrigatorios por etapa barram avanco, nao qualificam lead"),
    ...
    ("COMERCIAL/Qualificacao", "Descarte com motivo", campo("deals", "lost_reason"), "PARCIAL — motivo obrigatorio na perda da oportunidade, nao no descarte do lead"),
    ("COMERCIAL/Qualificacao", "SLA de atendimento", False, "AUSENTE"),
    ("COMERCIAL/Qualificacao", "Fila de leads sem acao", rota("/work-queue"), "PARCIAL — a fila e de tarefas; leads sem acao nao tem fila"),
    ("COMERCIAL/Qualificacao", "Qualificacao explicavel e auditavel", qualquer("audit_event"), "PARCIAL — a trilha registra tudo, mas nao ha decisao de qualificacao a explicar"),
    ...
    ("PARIDADE/Vendas", "Leads", campo("contacts", "status"), "PARCIAL — lead e um status de contato, nao um dominio"),
    ...
    ("PARIDADE/Vendas", "Distribuicao automatica", False, "AUSENTE"),
    ...
    ("PARIDADE/Marketing", "UTMs", codigo("services.py", "utm_source"), "PARCIAL — capturadas na entrada, nao consultaveis nem agregadas"),
    ...
    ("PARIDADE/Marketing", "Lead scoring", False, "AUSENTE"),
    ...
    ("PARIDADE/Atendimento", "SLA", False, "AUSENTE"),
